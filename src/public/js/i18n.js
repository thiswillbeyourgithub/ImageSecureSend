...
const i18n = (function() {
    ...
    const translations = {
        en: {
            ...
            'receive.exportBtnCount': 'Export All ({count} image{plural})',
            ...
            'receive.exportOCR': 'OCR (searchable PDF)',
            ...
            'receive.ocrProcessing': '⏳ OCR processing... this may take a moment',
            'receive.ocrInitializing': '⏳ Loading OCR engine...',
            'receive.crop': '✂️ Crop',
            'receive.download': '📥 Download',
            'receive.discard': '🗑️ Discard',
            'receive.discardConfirm': 'Remove this photo?',
            'receive.discardYes': '✓ Yes, remove',
